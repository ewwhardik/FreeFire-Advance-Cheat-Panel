...
namespace ART
{
    ...
    public class art
    {
        ...
        private static extern void GetSystemInfo(out art.SYSTEM_INFO lpSystemInfo);
        [DllImport("kernel32.dll")]
        public static extern IntPtr OpenProcess(uint dwDesiredAccess, bool bInheritHandle, int dwProcessId);
        [DllImport("kernel32")]
        public static extern bool IsWow64Process(IntPtr hProcess, out bool lpSystemInfo);
        [DllImport("kernel32.dll")]
        private static extern bool VirtualProtectEx(IntPtr hProcess, UIntPtr lpAddress, IntPtr dwSize, art.MemoryProtection flNewProtect, out art.MemoryProtection lpflOldProtect);
        [DllImport("kernel32.dll")]
        ...
        public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out art.MEMORY_BASIC_INFORMATION64 lpBuffer, UIntPtr dwLength);
        [DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx")]
        public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out art.MEMORY_BASIC_INFORMATION32 lpBuffer, UIntPtr dwLength);
        ...
        public string LoadCode(string name, string file)
        {
            ...
            if (flag)
            {
                uint privateProfileString = art.GetPrivateProfileString("codes", name, "", stringBuilder, (uint)stringBuilder.Capacity, file);
            }
            else
            {
        ...
        public byte[] AhReadMeFucker(string code, long length, string file = "")
        {
            ...
            bool flag = !art.ReadProcessMemory(this.pHandle, code2, array, (UIntPtr)(checked((ulong)length)), IntPtr.Zero);
            byte[] result;
            if (flag)
            {
                result = null;
        ...
        public Task<IEnumerable<long>> AoBScan(long start, long end, string search, bool readable, bool writable, bool executable, string file = "")
        {
            return Task.Run<IEnumerable<long>>(delegate ()
            {
                ...
                art.SYSTEM_INFO system_INFO = default(art.SYSTEM_INFO);
                art.GetSystemInfo(out system_INFO);
                ...
                art.MEMORY_BASIC_INFORMATION memory_BASIC_INFORMATION = default(art.MEMORY_BASIC_INFORMATION);
        ...
        private unsafe long[] CompareScan(MemoryRegionResult item, byte[] aobPattern, byte[] mask)
        {
            ...
            ulong num;
            art.ReadProcessMemory(this.pHandle, item.CurrentBaseAddress, intPtr, (UIntPtr)((ulong)item.RegionSize), out num);
        ...
        public UIntPtr VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out art.MEMORY_BASIC_INFORMATION lpBuffer)
        {
            bool flag = this.Is64Bit || IntPtr.Size == 8;
            UIntPtr result;
            if (flag)
            {
                art.MEMORY_BASIC_INFORMATION64 memory_BASIC_INFORMATION = default(art.MEMORY_BASIC_INFORMATION64);
                UIntPtr uintPtr = art.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION)));
            ...
            {
                art.MEMORY_BASIC_INFORMATION32 memory_BASIC_INFORMATION2 = default(art.MEMORY_BASIC_INFORMATION32);
                UIntPtr uintPtr = art.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION2, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION2)));
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (flag6)
                    {
                        ...
                        if (flag9)
                        {
                            art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)this.mainModule.BaseAddress + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                        }
                        else
                        {
                            ...
                            if (flag10)
                            {
                                ...
                                art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)value + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                            else
                            {
                                art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)array4[0]), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                        }
                        ...
                        for (int j = 1; j < array4.Length; j++)
                        {
                            ...
                            art.ReadProcessMemory(this.pHandle, uintPtr, array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
        ...
        //art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606//art dc :arts606
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (flag7)
                        {
                            ...
                            if (flag10)
                            {
                                art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)this.mainModule.BaseAddress + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                            else
                            {
                                ...
                                if (flag11)
                                {
                                    ...
                                    art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)value + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                                }
                                else
                                {
                                    art.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                                }
                            }
        ...
        public bool WriteMemory(string code, string type, string write, string file = "", Encoding stringEncoding = null)
        {
            ...
            return art.WriteProcessMemory(this.pHandle, code2, array, (UIntPtr)((ulong)((long)num)), IntPtr.Zero);
        }
        public bool IsAdmin()
        {
            bool result;
        ...
        public bool OpenProcess(int pid)
        {
            ...
            if (flag)
            {
                Debug.WriteLine("WARNING: You are NOT running this program as admin! Visit https://discord.gg/cyberincognito");
                notify("WARNING: You are NOT running this program as admin! For More Help Visit https://discord.gg/cyberincognito");
            }
            bool flag2 = pid <= 0;
            bool result;
            if (flag2)
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            this.pHandle = art.OpenProcess(2035711U, true, pid);
                            ...
                            else
                            {
                                ...
                                this.GetModules();
                                bool flag6;
                                this.Is64Bit = (Environment.Is64BitOperatingSystem && art.IsWow64Process(this.pHandle, out flag6) && !flag6);
        ...
        public bool ChangeProtection(string code, art.MemoryProtection newProtection, out art.MemoryProtection oldProtection, string file = "")
        {
            UIntPtr code2 = this.GetCode(code, file, 8);
            ...
            if (flag)
            {
                oldProtection = (art.MemoryProtection)0U;
                result = false;
            }
            else
            {
                result = art.VirtualProtectEx(this.pHandle, code2, (IntPtr)(this.Is64Bit ? 8 : 4), newProtection, out oldProtection);
            }
            return result;
        }
