...
namespace ART
{
    public class AntiDllInjection
    {
        ...
        public static string BinaryImageSignatureMitigationAntiDllInjection()
        {
            ...
            if (SetProcessMitigationPolicy(8, ref OnlyMicrosoftBinaries, Marshal.SizeOf(typeof(PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY))))
                return "Success";
            return "Failed";
        }
        ...
        {
            PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY policy = new PROCESS_MITIGATION_BINARY_SIGNATURE_POLICY
            {
